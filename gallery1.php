                         ...
                         <div class="wow fadeInUp color-white media" data-wow-delay="1.2s">
                            <div class="demo-gallery">
                                ...
                                <?php 
                                    ...
                                    for($i = 29; $i >= 0; $i--)
                                    {
                                        $item_count = $numberOfDays + $i;
                                        if($item_count > 365) 
                                            $item_count = $item_count - 365;

                                        $item = $datajson->resource[$item_count];
                                        ...
                                        $display_thumbnail = str_replace("xxxhdpi","thumbnail",$display_photo);

                                        if($item->content_type == "DROP_OF_NECTOR")
                                            $display_content = $item->content_text;
                                        else
                                            $display_content = "";
                                ...
                                ?> 
                                                ...
                                                <li class="col-xs-6 col-sm-4 col-md-3" data-order="<?=$order?>"  data-src="<?=$display_photo?>" data-sub-html='<p> <?=$display_content?> </p> ' >
                                                    <a href="" >
                                                        <img class="img-responsive gallery3-img" ci-src="<?=$display_thumbnail?>" style="width:100px"> 
                                                    </a>
                                                    <br />

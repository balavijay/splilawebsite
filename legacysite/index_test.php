...
<head>
    ...
    <link rel="stylesheet" href="css/hpslider.css">
				...
				<li>
                    ...
                    <div class="caption"> 
                        ...
                        <!-- <div>
							...
							<span>likes<span><?=$fc?></span></span>

							<span>views<span><?=$rc?></span></span>

							<span>downloads<span><?=$dc?></span></span>

							<span>shares<span><?=$sc?></span></span>
...
?>
         ...
         <!-- Slideshow  Pager -->
        <ul class="rslides_tabs" id="hpslider-pager">
...
?>				
            ...
            <li>
                <a href="#"><img src="<?=$card->photo_url?>" alt=""></a>
            </li>
...
<script>
        ...
        $( document ).ready(function() {
            ...
            // Slideshow 
            $("#hpslider").responsiveSlides({
                auto: true,
                manualControls: '#hpslider-pager',
                pager: true,
                nav: true,
                speed: 500,
                namespace: "callbacks"

<?php
	...
	"legacysite/quotes"								 => "menu_content_popup.php",
	...
	/* newsite Menus */
	"newsite"						=> "newsite/index.php",
	"newsite_quotes"				=> "newsite/gallery1.php",
	"newsite_srila-prabhupada-analogies"				=> "newsite/gallery3.php",
	"newsite_srila-prabhupada-biography"	=> "newsite/gallery3.php",
	"newsite_srila-prabupada-rare-pictures"				=> "newsite/gallery1.php",
	"newsite_eulogies-by-eminent"	=> "newsite/gallery3.php",
	"newsite_predictions"			=> "newsite/gallery3.php",
	"newsite_quick-facts"			=> "newsite/gallery1.php",
	"newsite_voyage-of-compassion"	=> "newsite/gallery3.php",
	"newsite_108_temples"			=> "newsite/gallery4.php",
	"newsite_poetry-by-prabhupada"	=> "newsite/gallery3.php",
	"newsite_poetry-for-prabhupada"	=> "newsite/gallery3.php",

	"newsite_srila-prabhupada-memories" => 	"newsite/memory_home.php",
	"newsite_mail-confirmation"			=>	"newsite/mail_confirmation.php",
	"newsite_subscribe"					=>	"newsite/subscribe-to-newsletter.php",
	"newsite_acknowledge"				=> 	"newsite/acknowledgements.php",
	"newsite_testimonials"				=> 	"newsite/testimonials.php",
	"newsite_search-results"			=> 	"newsite/search_results.php",
	"newsite_support-us"				=> 	"newsite/support-us.php",
	"newsite_share-with-us"				=> 	"newsite/share-with-us.php",
	"newsite_share-confirmation"		=>	"newsite/mail_confirmation.php",
	"newsite_support-confirmation"		=>	"newsite/mail_confirmation.php",
	"newsite_who-is-srila-prabhupada"		=>	"newsite/whois.php",

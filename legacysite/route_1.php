<?php
	...
	"quotes_test"								 	=> "menu_content_popup_test2.php",

	"quick-facts_test"							 	=> "menu_content_popup_test2.php",

	

	"srila-prabupada-rare-pictures_test" 		 	=> "menu_content_popup_test2.php",

	"voyage-of-compassion_test" 		 			=> "menu_content_popup_test3.php",

	"srila-prabhupada-analogies_test" 		 	 	=> "menu_content_popup_test2.php",

<?php
	...
	$url = "https://srilaprabhupadalila.com/v2/api/content?queryId=QUERY_GET_CONTENT&args=content_id:$rid,keyword_id:$kid,web:1";
				...
				<div class="col-md-10  img-portfolio">
                    <div class="art-img-box ">
                        ...
                        -->
								...
								<div>
									<a href="<?=$previous?>" class="section-btn btn btn-success" > << Pervious </a>
									<a href="<?=$next?>" class="section-btn btn btn-success" > Next >> </a>
								</div>		
